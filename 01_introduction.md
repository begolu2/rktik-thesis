...
Souma, the predecessor of Rktik, was originally motivated by the wish to share files with groups of friends without reliance on the goodwill of centralistic providers of social networking systems. In 2012 such a system did not exist and thus I started the implementation of this idea in the *Souma* app. In the course of development however, the goals and motivations of the project changed significantly.
